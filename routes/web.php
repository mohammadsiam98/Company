...
//about-us Route
Route::get('/another_route', 'App\Http\Controllers\HomepageController@starterPage')->name('starterPage');
//about-us Route
...
//sector Route
Route::get('/sectors/{id}', 'App\Http\Controllers\SectorsController@sectors')->name('sectors');
//sector Route
