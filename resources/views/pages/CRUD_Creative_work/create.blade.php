...
<head>
    ...
    <title>Dashboard | Creative Works</title>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                ...
                <ul class="menu-categories">
                    ...
                    {{---------------------------------- Creative Works ---------------------------------}}
                    <li class="menu">
                        <a href="#creativeWork" data-active="true" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Creative works</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="modal-text">In this Section we will insert some random works of our company which will show in the index page, of our company. Below You can see in which section does it affect in our website.</p>
                                                    <img src="{{asset('dashboardAssets/assets/img/RandomCreativeWork.PNG')}}" style=" display:block; margin-left:auto; margin-right:auto; width:300px" alt="">
                                                </div>
                    ...
                    <div class="row">
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('creative_work.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        {{method_field('PUT')}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="creative_work_name" placeholder="Write Your Creative Work Name">
                                            </div>
                                        </div>
                                        {{----------------- Creative work Name --------------}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="creative_work_sector_name" placeholder="Write Sector Name">
                                            </div>
                                        </div>
