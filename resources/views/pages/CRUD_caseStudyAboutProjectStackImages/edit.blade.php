                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Case Study Single Project Stack Images</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('caseStudyAboutProjectStackImages.update',$stackImagesCaseStudySingleProject->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker" name="caseStudy_id" data-live-search="true" data-width="100%">
                                                            ...
                                                            <option <?php if($stack->id == $stackImagesCaseStudySingleProject->caseStudy_id){?> selected <?php }  ?> value="{{ $stack->id }}">{{ $stack->thumbnail_case_study_title }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <img style="height: 70px; width:auto;" src="{{url($stackImagesCaseStudySingleProject->image)}}" alt="image">
                                        </div>
                                        {{------------------------- Image Preview --------------------------}}
