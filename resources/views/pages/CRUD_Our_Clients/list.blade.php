                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table class="multi-table table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($ourClients as $key =>$Clients)
                                    <tr>
                                        <td>{{$key +1 }}</td>
                                        <td> <img style="height: 70px; width:auto;" src="{{url($Clients->clients_image)}}" alt="image"></td>
                                        <td>
                                            <div class="row">
                                                <div>
                                                    <a href="{{route('ourClients.edit' , $Clients->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                                                </div>
                                                <div>
                                                    <form action="{{route('ourClients.destroy', $Clients->id)}}" method="POST">
                                                        @csrf
                                                        @method('Delete')
