...
<head>
    ...
    <link href="{{asset('dashboard_assets/assets/css/loader.css')}}" rel="stylesheet" type="text/css" />
    <script src="{{asset('dashboard_assets/assets/js/loader.js')}}"></script>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($SectorPricingbasicDetails as $key=>$basicServices)
                                        <tr>
                                            <td class="checkbox-column text-center"> {{$key+1}} </td>
                                            <td class="text-center">{{$basicServices->get_plan_name($basicServices->basicPlan_id)}}</td>
                                            <td class="text-center">{{$basicServices->services_name}}</td>
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li><a href="{{route('basicDetails.edit' , $basicServices->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1">
                                                                <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                            </svg></a></li>
                                                    <li><a href="{{ route('basicDetails.destroy', $basicServices->id) }}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash p-1 br-6 mb-1">
