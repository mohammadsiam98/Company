...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('dashboardAssets/assets/css/elements/alert.css')}}">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('basicDetails.store')}}" method="POST">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="services_name" id="services_name" aria-describedby="services_name" placeholder="Basic Plan Services Names">
