...
<head>
    ...
    <title>Dashboard | Sector Overview Details</title>
                ...
                <div class="container">
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Sector Overview Details</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="modal-text">In this Section we will write the details, of this category. Below You can see in which section does it affect in our website.</p>
                                                    <img src="{{asset('dashboardAssets/assets/img/ServiceOverview.PNG')}}" style=" display:block; margin-left:auto; margin-right:auto; width:300px" alt="">
                                                </div>
                    ...
                    <div class="row">
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('ServiceOverviewDetails.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        {{method_field('PUT')}}

                                        {{-- Category List --}}
                                        <div class="form-group row mb-4">
                                            <label for="category" class="col-xl-2 col-sm-3 col-sm-12 col-form-label">Category</label>
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Page Heading</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="page_heading" placeholder="Write Your Service Page Heading">
                                            </div>
                                        </div>
                                        {{-- Page Header(Dynamic-> Category Wise) --}}
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Service Title</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="service_overview_title" placeholder="Write Your Service Overview Title">
                                            </div>
                                        </div>
                                        {{-- Service Title(Dynamic-> Category Wise) --}}
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Service Overview</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea name="service_overview_details" class="form-control" id="" cols="30" rows="10" placeholder="Write Your Service Overview Details"></textarea>
                                            </div>
                                        </div>
                                        {{-- Service Overview(Dynamic-> Category Wise) --}}
                                        ...
                                        <label for="hEmail" class="col-xl-12 col-form-label">Sector Service Overview Image Upload</label>
                                        ...
                                        {{-- Service Overview Image Image Uplaod Section(Dynamic-> Category Wise) --}}
