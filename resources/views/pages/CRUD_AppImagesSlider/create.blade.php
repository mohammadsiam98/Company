...
<head>
    ...
    <title>Dashboard | App images sliders </title>
                ...
                <div class="container">
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Case Study Single Project Image Slider</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('caseStudyslider.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{method_field('PUT')}}
                                        ...
                                        <div class="form-group row mb-4">
                                            <label for="caseStudy_id" class="col-xl-2 col-sm-3 col-sm-12 col-form-label">Project Name</label>
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker" name="caseStudy_id" data-live-search="true" data-width="100%">
                                                            ...
                                                            <option value="{{ $stack->id }}">{{ $stack->thumbnail_case_study_title }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        {{------------------------- Submit Button --------------------------}}
                                        <button type="submit" class="btn btn-lg btn-primary mt-3 btn-lg">Submit</button>
                                        {{------------------------- Image Upload --------------------------}}
