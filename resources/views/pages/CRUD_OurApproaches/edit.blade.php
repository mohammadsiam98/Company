                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('OurApproaches.update',$OurApproaches->id)}}" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker" name="category_id" data-live-search="true" data-width="100%">
                                                            ...
                                                            <option <?php if($category->id == $OurApproaches->category_id){?> selected <?php }  ?> value="{{ $category->id }}">{{ $category->category_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="category_title" value="{{$OurApproaches->category_title}}" placeholder="Write Your Category Title">
                                            </div>
                                        </div>
                                        {{---------------------- Category Title(Dynamic-> Category-Wise) -------------------------}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea name="category_description" id="" class="form-control" cols="30" rows="10" placeholder="Write Some Description about this category (Our Approaches)">{{ $OurApproaches->category_description }}</textarea>
                                            </div>
                                        </div>
                                        {{---------------------- Category Description(Dynamic-> Category-Wise) -------------------------}}
                                        ...
                                        {{---------------------- Approach Details(Dynamic-> Category-Wise) -------------------------}}
                                        <div class="form-group row mb-4">
