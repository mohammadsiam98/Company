                ...
                <div class="container">
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Our Approaches</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="modal-text">In this Section we will write the details of our approaches, using category. Below You can see in which section does it affect in our website.</p>
                                                    <img src="{{asset('dashboardAssets/assets/img/OurApproaches.PNG')}}" style=" display:block; margin-left:auto; margin-right:auto; width:300px" alt="">
                                                </div>
                    ...
                    <div class="row">
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('OurApproaches.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        {{method_field('PUT')}}
                                        {{---------------------- Category(Dynamic) -------------------------}}
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker form-control" name="category_id" data-live-search="true" data-width="100%">
                                        ...
                                        {{---------------------- Category Title(Dynamic-> Category-Wise) -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="category_title" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Category Main Page Title Header</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="category_title" placeholder="Write Your Category Title">
                                            </div>
                                        </div>
                                        {{---------------------- Category Title(Dynamic-> Category-Wise) -------------------------}}
                                        ...
                                        {{---------------------- Category Description(Dynamic-> Category-Wise) -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="category_description" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Category Description</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea name="category_description" id="" class="form-control" cols="30" rows="10" placeholder="Write Some Description about this category (Our Approaches)"></textarea>
                                            </div>
                                        </div>
                                        {{---------------------- Category Description(Dynamic-> Category-Wise) -------------------------}}
                                        ...
                                        {{---------------------- Approach Title(Dynamic-> Category-Wise) -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="Approach_title" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Approach Title</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="Approach_title" placeholder="Write Your Approach Title">
                                            </div>
                                        </div>
                                        {{---------------------- Approach Title(Dynamic-> Category-Wise) -------------------------}}
                                        ...
                                        {{---------------------- Approach Description(Dynamic-> Category-Wise) -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="Approach_details" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Approach Details</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea name="Approach_details" id="" class="form-control" cols="30" rows="10" placeholder="Write Some Description on that Approach Details"></textarea>
                                            </div>
                                        </div>
                                        {{---------------------- Approach Description(Dynamic-> Category-Wise) -------------------------}}
