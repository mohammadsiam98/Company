                            ...
                            <table class="multi-table table table-hover" style="width:100%">
                                <thead style="border-bottom: none;">
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Approach Title</th>
                                ...
                                <tbody>
                                    @foreach ($OurApproaches as $key =>$OurApproach)
                                    <tr>
                                        <td style="text-align: center;">{{$key +1 }}</td>
                                        <td style="text-align: center;">{{$OurApproach->Approach_title}}</td>
                                        <td style="text-align: center;" class="text-center">{{$OurApproach->get_category_name($OurApproach->category_id)}}</td>
                                        <td style="text-align: center;">{{$OurApproach->category_title}}</td>
                                        <td>
                                            <div class="row">
                                                <div>
                                                    <a href="{{route('OurApproaches.edit' , $OurApproach->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                                                </div>
                                                <div>
                                                    <form action="{{route('OurApproaches.destroy', $OurApproach->id)}}" method="POST">
                                                        @csrf
                                                        @method('Delete')
