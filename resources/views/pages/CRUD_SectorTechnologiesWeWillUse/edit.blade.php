                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Sector Stack Names</a></li>
                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('SectorTechnologiesWeWillUse.update',$SectorTechnologiesWeWillUse->id)}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Section Title</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="technology_main_title" value="{{$SectorTechnologiesWeWillUse->technology_main_title}}" placeholder="Write Technology Section Main Header Title">
                                            </div>
                                        </div>

                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Section Details</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="technology_main_title_short_details" value="{{$SectorTechnologiesWeWillUse->technology_main_title_short_details}}" placeholder="Write Technology Section Main Header Details">
                                            </div>
                                        </div>
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker" name="category_id" data-live-search="true" data-width="100%">
                                                            ...
                                                            <option <?php if($category->id == $SectorTechnologiesWeWillUse->category_id){?> selected <?php }  ?> value="{{ $category->id }}">{{ $category->category_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
