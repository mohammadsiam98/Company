                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p class="modal-text">In this Section we will write the details, of our company. Below You can see in which section does it affect in our website.</p>
                                                    <img src="{{asset('dashboardAssets/assets/img/AboutUsImage.PNG')}}" style=" display:block; margin-left:auto; margin-right:auto; width:300px" alt="">
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-warning" role="alert">
                                <h1>You have already inserted <strong> agency details</strong> & <strong>Why choose us</strong> content !! Now you can only Edit them !</h1>
                            </div>
                        </div>
                    </div>
                    @endif
