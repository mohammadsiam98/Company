        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="image-block upset bg-shape wow fadeIn">
                    <img src="{{asset('assets/images/web.svg')}}" alt="image" class="img-fluid" />
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading ptag">
                    <span>Process</span>
                    <h1 class="text-radius text-light text-animation bg-b">Our Web Development Clients</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading ptag">
                    ...
                    <h1 class="text-radius text-light text-animation bg-b">Programming Stacks</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/teama.svg')}}" alt="service" class="img-fluid"></div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/link.svg')}}" alt="service" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/tech.svg')}}" alt="service" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/hi.svg')}}" alt="service" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/badge.svg')}}" alt="service" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="{{asset('assets/images/icons/tin.svg')}}" alt="service" class="img-fluid"></div>
                    <div class="s-block-content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-table best-plan mt60 bg-gradient4">
                    <div class="inner-table">
                        <img src="{{asset('assets/images/icons/plan-2.svg')}}" alt="Advance" />
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing-table mt60">
                    <div class="inner-table">
                        <img src="{{asset('assets/images/icons/plan-3.svg')}}" alt="Ultimate" />
