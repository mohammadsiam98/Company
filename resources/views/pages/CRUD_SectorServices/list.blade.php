            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Sector Services Table Dynamic</a></li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table class="multi-table table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($SectorServices as $key =>$SectorService)
                                    <tr>
                                        <td>{{$key +1 }}</td>
                                        <td>{{$SectorService->get_category->category_name}}</td>
                                        <td>{{$SectorService->service_name}}</td>
                                        <td>{{$SectorService->service_details}}</td>
                                        <td> <img style="height: 70px; width:auto;" src="{{url($SectorService->image)}}" alt="image"></td>
                                        <td>
                                            <div class="row">
                                                <div>
                                                    <a href="{{route('SectorServices.edit' , $SectorService->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                                                </div>
                                                <div>
                                                    <form action="{{route('SectorServices.destroy', $SectorService->id)}}" method="POST">
                                                        @csrf
                                                        @method('Delete')
