                ...
                <div class="container">
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Sector Services Form</a></li>
                            </ol>
                        </nav>
                    </div>
                    {{--------------- Form Start -----------------}}
                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('SectorServices.store')}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        {{method_field('PUT')}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="service_name" placeholder="Write Your Service Name">
                                            </div>
                                        </div>
                                        {{---------------------- Service Name  -------------------------}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="service_details" placeholder="Write Your Service Details">
                                            </div>
                                        </div>
                                        {{---------------------- Service Details  -------------------------}}
