...
<head>
    ...
    <title>Dashboard | Sector Services</title>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                ...
                <ul class="menu-categories">
                    ...
                    <li class="menu">
                        <a href="#SectorServices" data-active="true" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                ...
                <div class="container">
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Sector Services Form</a></li>
                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('SectorServices.update',$SectorServices->id)}}" enctype="multipart/form-data" method="POST">
                                        @csrf

                                        {{---------------------- Service Name  -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Service Name</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="service_name" value="{{$SectorServices->service_name}}" placeholder="Write Your Service Name">
                                            </div>
                                        </div>
                                        {{---------------------- Service Name  -------------------------}}
                                        ...
                                        {{---------------------- Service Details  -------------------------}}
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Service Details</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="service_details" value="{{$SectorServices->service_details}}" placeholder="Write Your Service Details">
                                            </div>
                                        </div>
                                        {{---------------------- Service Details  -------------------------}}
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    <div class="widget-content widget-content-area">
                                                        <select class="selectpicker" name="category_id" data-live-search="true" data-width="100%">
                                                            ...
                                                            <option <?php if($category->id == $SectorServices->category_id){?> selected <?php }  ?> value="{{ $category->id }}">{{ $category->category_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <img src="{{url($SectorServices->image)}}" style="height: 100px;width:auto" alt="">
                                            </div>
                                        </div>
                                        {{---------------------- Image Preview  -------------------------}}
