                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('SectorCreativeWorks.update',$SectorCreativeWorks->id)}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Work Name</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="creative_work_name" value="{{$SectorCreativeWorks->creative_work_name}}" placeholder="Write Your Creative Work Name">
                                            </div>
                                        </div>

                                        <div class="form-group row mb-4">
                                            <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Creative Work Sector</label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="creative_work_sector" value="{{$SectorCreativeWorks->creative_work_sector}}" placeholder="Write Your Creative Work Sector">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <img src="{{url($SectorCreativeWorks->image)}}" style="height: 100px;width:auto" alt="">
                                            </div>
                                        </div>
