            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Sector Creative Works Table</a></li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table class="multi-table table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($SectorCreativeWorks as $key =>$SectorWorks)
                                    <tr>
                                        <td>{{$key +1 }}</td>
                                        <td>{{$SectorWorks->get_category->category_name}}</td>
                                        <td>{{$SectorWorks->creative_work_name}}</td>
                                        <td>{{$SectorWorks->creative_work_sector}}</td>
                                        <td> <img style="height: 70px; width:auto;" src="{{url($SectorWorks->image)}}" alt="image"></td>
                                        <td>
                                            <div class="row">
                                                <div>
                                                    <a href="{{route('SectorCreativeWorks.edit' , $SectorWorks->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                                                </div>
                                                <div>
                                                    <form action="{{route('SectorCreativeWorks.destroy', $SectorWorks->id)}}" method="POST">
                                                        @csrf
                                                        @method('Delete')
