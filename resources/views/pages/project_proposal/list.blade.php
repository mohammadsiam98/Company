...
<head>
    ...
    <title>Project Proposal List</title>
                                ...
                                <table id="style-3" class="table style-3  table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Refference site</th>
                                            <th class="text-center">Message</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($ProjectProposalDetails as $key=>$projectProposal)
                                        <tr>
                                            <td class="checkbox-column text-center"> {{$key+1}} </td>
                                            <td class="text-center">{{$projectProposal->name}}</td>
                                            <td class="text-center">{{$projectProposal->email}}</td>
                                            <td class="text-center">{{$projectProposal->refSite}}</td>
                                            <td class="text-center">{{$projectProposal->message}}</td>
                                        </tr>
                                        @endforeach
