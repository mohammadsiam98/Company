        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                ...
                <ul class="menu-categories">
                    ...
                    <li class="menu">
                        <a href="#contact-information" data-active="true" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                <table id="style-3" class="table style-3  table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($ContactUsDetails as $key=>$contactUs)
                                        <tr>
                                            <td class="checkbox-column text-center"> {{$key+1}} </td>
                                            <td class="text-center">{{$contactUs->name}}</td>
                                            <td class="text-center">{{$contactUs->email}}</td>
                                            <td class="text-center">{{$contactUs->number}}</td>
                                            <td class="text-center">{{$contactUs->message}}</td>
                                        </tr>
                                        @endforeach
