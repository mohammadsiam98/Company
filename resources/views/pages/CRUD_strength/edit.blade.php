                        ...
                        <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <form action="{{route('strength.update',$strength->id)}}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control" name="strength_title" value="{{$strength->strength_title}}" placeholder="Write Your Company's Strength Title">
                                            </div>
                                        </div>
                                        {{----------------------- Strength Title --------------------}}
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <textarea name="strength_description" id="" class="form-control" cols="30" rows="10" placeholder="Write Some Description on that strength title">{{ $strength->strength_description }}</textarea>
                                            </div>
                                        </div>
                                        {{----------------------- Strength Description --------------------}}
