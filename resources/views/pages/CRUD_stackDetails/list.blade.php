            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Stack Details Table</a></li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table class="multi-table table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($stackDetails as $key =>$stack)
                                    <tr>
                                        <td>{{$key +1 }}</td>
                                        <td>{{$stack->get_technology_name->technology_main_title}}</td>
                                        <td>{{$stack->technology_name}}</td>
                                        <td>{{$stack->technology_short_details}}</td>
                                        <td> <img style="height: 70px; width:auto;" src="{{url($stack->image)}}" alt="image"></td>
                                        <td>
                                            <div class="row">
                                                <div>
                                                    <a href="{{route('sector_technologies_details.edit' , $stack->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                                                </div>
                                                <div>
                                                    <form action="{{route('sector_technologies_details.destroy', $stack->id)}}" method="POST">
                                                        @csrf
                                                        @method('Delete')
